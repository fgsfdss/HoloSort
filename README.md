...
The version in this repo is built for characters from [Hololive](https://en.wikipedia.org/wiki/Hololive), but the sorter can be easily edited to create any custom sorter desired.
